...
| 1 | éka | /ˈe.ka/ | Sánscrito *eka* "uno" + Avestan *aēva-* → reducción a éka. 2 lenguas. |
...
| 9 | náva | /ˈna.wa/ | Sánscrito *náva* + Avestan *nava*. 2 lenguas. |
| 10 | dásha | /ˈda.ʃa/ | Sánscrito *dáśa* + Avestan *dasa*. 2 lenguas. |
| 100 | sháta | /ˈʃa.ta/ | Sánscrito *śata* + Avestan *sata*. 2 lenguas. |
| 1000 | házar | /ˈha.zar/ | Persa *hazār* + Sánscrito *sahásra* → házar (reducción). 2 lenguas. |

#### Formación de números mayores

```
11 = dásha éka        "diez uno"
12 = dásha dwi        "diez dos"
20 = dwi-dásha        "dos-diez" (veinte)
21 = dwi-dásha éka    "veintiuno"
99 = náva-dásha náva  "noventa y nueve"
100 = sháta           "cien"
101 = sháta éka       "ciento uno"
356 = tiri-sháta páncha-dásha shásh
1000 = házar
2026 = dwi-házar dwi-sháta dwi-dásha shásh
```
...
| náva | **návath** | "noveno/a" — Regular. |
| dásha | **dáshath** | "décimo/a" — Regular. |
| sháta | **shátath** | "centésimo/a" — Regular. |

**Irregulares:**
- **púrwa** /ˈpur.wa/ = "primero/a" (variante culta, del Sánscrito *pūrva* "primero, anterior, oriental" + Persa *parv* "primero, previo". 2 lenguas.) — Se usa como **raíz ordinal independiente**, más frecuente que ékath en textos rituales.
...
| **-sutra** | /ˈsu.tra/ | Objetos alargados (cuerdas, ríos, caminos) | Sánscrito *sūtra* "hilo, cuerda, línea" + Griego *νητόν* (nētón) "tejido, hilo" → sutra. 2 lenguas. | éka-sutra sota = "un río" |
...
**Notas:**
- El clasificador se **omite** con unidades de medida (házar "mil", sháta "cien"), conceptos temporales (dín "día", rátrí "noche"), y números ordinales.
...
```
éka-thang-sutra núr    = "una [redonda-y-alargada] luz" (un relámpago, un bastón de luz)
...
**Atestiguado en el corpus** (cuento y gramática): ya aparece en `ma núr kár-an ich-a` (§3.3.4, "quiero hacer luz") y en `ta ich-a éka` (cuento, "quiero uno").
...
| "todo es uno" | sara éka as-a | todo uno es-PRES |
...
<cardinal>       ::= "éka" | "dwi" | "tiri" | "chatúr" | "páncha"
                      | "shásh" | "sápta" | "áshta" | "náva" | "dásha"
                      | "sháta" | "házar"
                      | <cardinal>"-dásha" <cardinal>?
